...
// Uso de ejemplo:
let product = new Product('Producto Ejemplo', 10.99, 100);
product.showInfo(); // Muestra los detalles iniciales del producto
product.minusStock(5); // Disminuye el stock en 5 unidades
product.incrementStock(10); // Incrementa el stock en 10 unidades
product.updatePrice(12.99); // Actualiza el precio a 12.99
